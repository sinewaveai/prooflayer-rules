...
- **Agent-framework integration adapters** — added dependency-light wrappers for OpenAI Agents SDK, CrewAI, AutoGen, Semantic Kernel, and Pydantic AI.
- **Shared agent security primitives** — added common agent input/output scanning, unsafe handoff detection, role drift heuristics, and cross-agent instruction-smuggling checks.
- **Phase 3 examples and docs** — added runnable local examples and integration docs for all five agent-framework adapters.
...
[0.2.0]: https://github.com/sinewaveai/prooflayer-rules/releases/tag/v0.2.0
